                  ...
                  <div className="col-lg-6 col-md-8">
                    <div className="login_wrap widget-taber-content background-white">
                      <div className="padding_eight_all bg-white">
                        ...
                        {/* Before OTP */}
                        {!recievedOTP && <form method="post">
                          <div className="form-group">
                            <input type="text" required aria-required placeholder="Phone Number" value={phone} name="phone-number" onChange={handlePhoneNumberChange} className={isValid ? 'valid' : 'invalid'}
                            />
                          ...
                          {!sendOTP ? (<div className="form-group mb-30">
                            ...
                            <div>
                              <div className="form-group">
                                ...
                                <br />
                                {/* <input type="text" placeholder="Enter OTP" maxLength={6} onChange={handleOTPChange} value={codeOTP} pattern="[0-9]{3}-[0-9]{3}" /> */}
                                <OtpInput
                                  value={codeOTP}
                                  onChange={setCodeOTP}
                                  numInputs={6}
                                  inputStyle={{padding: '4px', width: '48px', margin: '0 4px'}}
                                  separator={<span>-</span>}
                        ...
                        {recievedOTP && <form method="post">
                          <div className="form-group">
                            <input type="text" required="" name="username" placeholder="Name" onChange={(e) => setName(e.target.value)}
                            />
                          </div>
                          <div className="form-group">
                          ...
                          <div className="form-group">
                            <input required="" type="password" name="password" placeholder="Confirm password" onChange={(e) => setConfirmPassword(e.target.value)} />
                          </div>
                          <div className="payment_option mb-50">
                            <div className="custome-radio">
                              <input className="form-check-input" required="" type="radio" name="payment_option" id="exampleRadios3" defaultChecked="" value="customer" onChange={(e) => setRole(e.target.value)}
                              />
                            ...
                            <div className="custome-radio">
                              <input className="form-check-input" required="" type="radio" name="payment_option" id="exampleRadios4" defaultChecked="" value="vendor" onChange={(e) => setRole(e.target.value)}
                              />
